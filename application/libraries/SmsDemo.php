...
require_once dirname(__DIR__) . '/libraries/aliyun/api_sdk/vendor/autoload.php';
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        //$accessKeyId = "LTAI2emWizjsgHvT"; // AccessKeyId
        $accessKeyId = "LTAIeiK53tqRMijK";

        //$accessKeySecret = "7MrZEKGr4caLb2EuMYyfd8djcFKfzv"; // AccessKeySecret
        $accessKeySecret = "KmnW7Jt2GloA1mbwm8ypKTy5wJr3sA";
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$tmp) {
        ...
        if($acsResponse->Code == 'OK'){
            $cache_name = 'sms_code' . $phone;
            cache('save', $cache_name, array('code' => $code, 'time' => time()), 600);//写入缓存
        }
        return $acsResponse;
    }
     ...
     * @return stdClass
     */
    public static function sendOtherSms($phone,$tmp,$date,$money,$phone1) {
